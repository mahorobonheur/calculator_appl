  ...
  Widget _buildContactItem(Contact contact) {
    return ListTile(
      leading: const CircleAvatar(
        backgroundImage: AssetImage('D:\Courses\2023-2024 Semester 5 Summer\Web Design\profile.jpg'),
        radius: 20,
      ),
                    ...
                    children: [
                      GestureDetector(
                        ...
                        child: const CircleAvatar(
                          radius: 40,
                          backgroundImage: AssetImage('D:\Courses\2023-2024 Semester 5 Summer\Web Design\profile.jpg'), // Placeholder image
